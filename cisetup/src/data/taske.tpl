		...
		<div class="panel panel-default center-panel">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form role="form" autocomplete="off" action="/task/{{.TaskId}}" method="post">
					    <div class="form-group">
					       ID:{{.TaskId}} Tocken:{{.TaskToken}}
					    </div>
						...
						<div class="form-group">
							<label for="TaskCmds">Команды сборки (новая команда с новой строки)  {{"{{"}}CHECK{{"}}"}} для вставки команды анализа сиходников или {{"{{"}}CHECK_CLEAR{{"}}"}} для коверити</label>
						...
						<div class="form-group">
							...
							<div class="controls1">
							    {{range .TaskaddPs}}
							    <div class="entry input-group col-xs-3">
									<input class="form-control" id="TaskaddPs" name="TaskaddPs" type="text" value="{{.}}"/>
									<span class="input-group-btn">
										<button class="btn btn-remove1 btn-danger" type="button">
